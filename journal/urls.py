...
urlpatterns = [
    ...
    re_path(r'authors/(?P<author_username>\w+?)/journal/create-journal/(?P<action>\w+?)/$', views.create_journal,
            name='create_journal'),
    re_path(r'authors/(?P<author_username>\w+?)/journal/create-journal/$', views.create_journal, name='create_journal'),
